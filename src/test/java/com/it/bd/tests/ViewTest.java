...
import com.it.bd.pages.ViewPage;
import com.it.bd.utilities.ExtentFactory;

public class ViewTest extends BaseDrivers {
	...
	public void viewTest() throws IOException {
		childTest = parentTest.createNode("<p style=\"color:#3E96E7; font-size:20px\"><b>View Any Book</b></p>");
		ViewPage viewPage = new ViewPage(childTest);
		viewPage.view();
	}
	@AfterClass
	public void report() {
