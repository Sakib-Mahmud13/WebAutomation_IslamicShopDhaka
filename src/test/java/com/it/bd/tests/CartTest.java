...
import com.it.bd.pages.CartPage;
import com.it.bd.utilities.ExtentFactory;

public class CartTest extends BaseDrivers {
	...
	public void viewTest() throws IOException {
		childTest = parentTest.createNode("<p style=\"color:#3E96E7; font-size:20px\"><b>Go To Cart</b></p>");
