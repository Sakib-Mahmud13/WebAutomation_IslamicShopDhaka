...
import com.it.bd.pages.CategoryPage;
//import com.it.bd.basedrivers.PageDriver;
import com.it.bd.utilities.ExtentFactory;

public class CategoryTest extends BaseDrivers{
...
//		Thread.sleep(10000);
	...
	public void categoryTest() throws IOException {
		childTest = parentTest.createNode("<p style=\"color:#3E96E7; font-size:20px\"><b>CATEGORY(জেনারেল বই)</b></p>");
